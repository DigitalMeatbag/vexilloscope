...
- All 402 flags train (v3: 255 Phase 1 + 51 US states + 16 historical Phase 5 + pride/HRE Phase 6); there is no held-out class split — eval uses augmented passes per flag
